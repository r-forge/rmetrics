...
function()
{
    ...
    # CVaR Portfolio:
    .cmlConstrainedCVaRPortfolio(data, spec, constraints)
...
function()
{
    ...
    # Portfolio:
    .tangencyConstrainedCVaRPortfolio(data, spec, constraints)
...
function()
{
    ...
    # CVaR Portfolio Optimization:
    .minvarianceConstrainedCVaRPortfolio(data, spec, constraints)
