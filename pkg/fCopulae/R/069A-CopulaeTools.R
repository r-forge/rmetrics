...
#  xmpCopulae           Sets Prompt
#  xmpfCopulae          Popups the example menu
################################################################################
...
{   # A function implemented by Diethelm WUertz
    ...
    # Popup:    
    path = paste(.Library,"/fCopulae", sep = "") 
    entries = .read.fCopulae.00Index (file.path(path, "demoIndex")) 
