...
################################################################################
# FUNCTION:                DESCRIPTION:
# assetsArrange             Returns assets rearranged in colum
...
.pcaColnames <-     .pcaArrange       
.hclustColnames <-  .hclustArrange        
.abcColnames <-     .abcArrange          
.orderColnames <-   .orderArrange          
.sampleColnames <-  .sampleArrange        
.statsColnames <-   .statsArrange 
