...
<<minorTicks>>=
par(mfrow=c(3, 1))                
plot(tS1, minor.ticks="day")
plot(tS1, minor.ticks="week")
plot(tS1, minor.ticks="month")
@
\medskip
...
par(mfrow=c(2, 2))
plot(tS1, ann=FALSE)                
plot(tS3, plot.type="s", ann=FALSE)                                   
plot(tS6, plot.type="s", ann=FALSE)
@
...
<<axisFontSize>>=
par(mfrow=c(3, 1))
plot(tS3, at="chic", cex.axis=0.75)                            
...
<<typeMultiple>>=
par(mfrow=c(1, 1))                                                
plot(tS3, plot.type="m", type=c("l", "p", "h"))
@
\medskip
...
<<palettesMultiple>>=
par(mfrow=c(1, 1))                                                
plot(tS6, plot.type="s", col=seqPalette(6, "Reds"), at="chic", format = "%B\n%Y")
@
\medskip
...
<<ltyMultiple>>=
par(mfrow=c(1, 1))                                                
plot(tS3, plot.type="m", col=1, lty=1:3)
@
\medskip
...
<<lwdMultiple>>=
par(mfrow=c(1, 1))                                                
plot(tS3, plot.type="m", col=1, lwd=3:1)
@
\medskip
...
plot(tS3weekly, plot.type="s", type="p", col=1:3, pch=21:23)
@
\medskip
...
plot(tS3, plot.type="s", type="p", 
  col=1:3, pch=21:23, cex.pch=c(0.2, 0.2, 0.2))
@
\medskip
...
plot(returns(tS3), plot.type="m", col = .colorwheelPalette(3),panel=lines2)
@
...
plot(returns(tS6), plot.type="m", col = .colorwheelPalette(6), panel=lines2)
@
...
This example shows how to add an EMA indicator to each plot panel.
...
plot(tS3, plot.type="m", col = .colorwheelPalette(3), panel=lines2, grid=TRUE)
@
