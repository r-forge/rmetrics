...
%%%%%%%%%%%%%%%%%%% moved from short intro (beginnig) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Linear Congruential Generators II}
...
$(u_i)_{1\leq i\leq n}$ of points in $I^d$, that are \textbf{not} random. As $n$ increases, we want
$$
