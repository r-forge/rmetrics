setClass("schwartz2factor",
         representation(call = "call",
                        ...
                        sigmaE = "numeric",
                        rhoSE = "numeric"),
         prototype(call = call("schwartz2factor"),
                   s0 = 100,
                   delta0 = 0,
                   mu = 0,
                   sigmaS = 0.3,
...
setClass("fit.schwartz2factor",
         ...
         prototype(n.iter = numeric(0),
                   ...
                   ## state = matrix(0),
                   deltat = 0.01),
         contains = "schwartz2factor"
         )

### <---------------------------------------------------------------------->

schwartz2factor <- function(s0 = 100, delta0 = 0,
                            mu = 0.1, sigmaS = 0.3,
