...
double (*WELLRNG21701aTemp)(void);

void InitWELLRNG21701aTemp(unsigned int *init ){
   int j;
   state_i=0;
   WELLRNG21701aTemp = case_1;
   for(j=0;j<R;j++)
      STATE[j]=init[j];
}
