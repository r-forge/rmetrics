...
// The function GetWELLRNG800b() was add for interface to R package randtoolbox/rngWELL
...
double (*WELLRNG800b)(void);

void InitWELLRNG800b(unsigned int *init )
{
  int j;
  state_i=0;
  WELLRNG800b = case_1;
...
void GetWELLRNG800b (unsigned int *state)
{
  int j, k;
  j = 0;
  for (k = state_i; k < R; k++)
