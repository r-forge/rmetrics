...
% %%\beamertemplatenavigationsymbolsempty ,handout

% %% neue deutsche Rechtschreibung
% \usepackage[english]{babel}
% \usepackage{lmodern}            %% Optimale Fonts für T1
...
scale invariant parametrizations. For a $d$-varite GH random variable
