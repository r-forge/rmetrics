...
#define PACKAGE_BUGREPORT "christophe.dutang@ensimag.fr"

/* Define to the full name of this package. */
#define PACKAGE_NAME "randsobolfortran"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "randsobolfortran 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "randsobolfortran"
